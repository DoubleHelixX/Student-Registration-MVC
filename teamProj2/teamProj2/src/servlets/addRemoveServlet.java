	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		{
			...
			if (courseAction.equals("ADD")) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/MyCourses.jsp");
				...
				RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/MyCourses.jsp");
				rd.forward(request, response);
			} else if (courseAction.equals("CANCEL") || courseAction.equals("NO")) {
				RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/MyCourses.jsp");
				rd.forward(request, response);
			}
		}
